							...
							<tbody>
								...
								<c:forEach items="${zulist}" var="zulist">
									...
									<tr
										...
										<td>${zulist.houselist.houseid}</td>
										...
										<td><a class="link-update"
											href="/hetong/showHeTong?house_id=${zulist.houselist.houseid}">查看合同</a>
											&nbsp;&nbsp; 
											
											<a class="link-del"
											 href="/hetong/deleteHeTong?house_id=${zulist.houselist.houseid}"
