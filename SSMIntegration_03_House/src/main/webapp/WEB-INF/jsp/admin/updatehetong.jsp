        ...
        <form action="/hetong/updateHeTong" method="post" id="myform" name="myform"  >
                    <table class="insert-tab" width="100%">
                        <tbody>
                                ...
                                <td>
                                    <input class="common-text required" value="${hetong.houseId}" id="house_id" name="houseId" size="50" type="text" readonly>
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>地址：</th>
                                <td><input class="common-text" name="houselist.address" value="${hetong.houselist.address}" id="address" size="50" type="text"></td>
                            </tr>
                            <tr>
                           ...
                           <tr>
                                ...
                                <td><input class="common-text" name="chuzuIdcard" value="${hetong.chuzuIdcard}" id="chuzu_idcard" size="50" type="text"></td>
                            </tr>
                             <tr>
                            ...
                            <tr>
                              ...
                              <td><input class="common-text" name="zukeIdcard" value="${hetong.zukeIdcard}" id="zuke_idcard" size="50" type="text"></td>
                            </tr>
                             <tr>
                            ...
                            <tr>
                              ...
                              <td><input class="common-text" name="houselist.price" id="price" value="${hetong.houselist.price}" size="50"  type="text" ></td>
                            </tr>
                            <tr>
